...
def execute_cmd(cmd):
    if cmd == 'ctime':
        ...
        # Radioni yoqish
        os.system("D:\VIA_Marokand_-_Boychechak_62674088.mp3")

    elif cmd == 'stupid1':
        # Yemagan xazil
        speak("Bitta afandi yoshligida o'lib qolibdi! ha ha ha")
...
speak("Salom Otajon Bozorboev")
speak("Yaxshimisiz? Nima gap. Qalaysiz")
